...
import { type AutomaticSpeechRecognitionTaskHelper, BaseConversationalTask, BaseTextGenerationTask, type FeatureExtractionTaskHelper, TaskProviderHelper, type TextToImageTaskHelper, type TextToSpeechTaskHelper } from "./providerHelper.js";
...
export declare class DeepInfraTextToImageTask extends TaskProviderHelper implements TextToImageTaskHelper {
    constructor();
    makeRoute(): string;
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(response: DeepInfraImageGenerationResponse, url?: string, headers?: HeadersInit, outputType?: OutputType, signal?: AbortSignal): Promise<string | Blob | Record<string, unknown>>;
}
export {};
