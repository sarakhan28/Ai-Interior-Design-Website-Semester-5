...
type OpenCv = Awaited<Awaited<typeof import("@techstark/opencv-js")>["default"]>;

let openCvPromise: Promise<OpenCv> | null = null;

export function loadOpenCv(): Promise<OpenCv> {
  openCvPromise ??= import("@techstark/opencv-js").then(({ default: opencv }) => Promise.resolve(opencv)).then((opencv) => {
